                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex items-start gap-3 pt-2">
                        ...
                        <label htmlFor="rgpd-consent" className="text-xs text-neutral-500 font-light leading-relaxed cursor-pointer">
                            He leído y acepto la <a href="https://pabloperez.es/politica-privacidad" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white underline underline-offset-4 transition-colors">Política de Privacidad</a> respecto al tratamiento de mis datos personales.
                        </label>
                    </div>
